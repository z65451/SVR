...
def main(gpu_id, model_path, datapath, save_root_path, group_size, img_size, img_dir_name,crf):
    ...
    with torch.no_grad():
        for p in range(len(datapath)):
            ...
            video=cv2.VideoWriter('output_video.avi',cv2.VideoWriter_fourcc(*'XVID'), 25,(960,540))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path',default='test_vids/Istanbul.mp4', help="dataset for evaluation")
