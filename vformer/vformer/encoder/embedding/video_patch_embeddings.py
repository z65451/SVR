...
class TubeletEmbedding(nn.Module):
    ...
    def __init__(self, embedding_dim, tubelet_t, tubelet_h, tubelet_w, in_channels):
        ...
        self.tubelet_embedding1 = nn.Sequential(
            Rearrange(
        ...
        self.tubelet_embedding2 = nn.Sequential(
            Rearrange(
                "b  (t pt) c (h ph) (w pw) -> b t (h w) (pt ph pw c)",
                pt=tubelet_t,
                ph=tubelet_h,
        ...
        self.linear = nn.Linear(tubelet_dim*2, embedding_dim)
    def forward(self, x1, x2):
        ...
        """
        x1 = self.tubelet_embedding1(x1)
        x2 = self.tubelet_embedding2(x2)
        x3 = torch.cat((x1, x2), 3)
        x3 = self.linear(x3)
